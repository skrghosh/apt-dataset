...
## APT Groups and Malware Knowledge Base

The table below outlines the APT groups and malware used to build the Knowledge Base along with their abbreviations as used in the paper.
